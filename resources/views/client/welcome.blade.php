                ...
                @auth
                    @if(auth()->user() && auth()->user()->role == 1)
                        <a href="{{ route('categories.index') }}"
                            class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#f53003] border border-[#f53003] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal font-medium">
                            🛡️ Quản trị
                        </a>
                    @endif
